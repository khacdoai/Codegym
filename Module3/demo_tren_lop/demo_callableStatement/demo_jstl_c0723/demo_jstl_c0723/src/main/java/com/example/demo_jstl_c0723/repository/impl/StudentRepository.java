...
public class StudentRepository implements IStudentRepository {
    ...
    private final String SEARCH_BY_NAME1 = "select * from student where name like ?;";
    private final String SEARCH_BY_NAME2 = "select * from student where name like concat('%',?,'%');";
    private final String SEARCH_BY_NAME3 = "select * from student where name like concat('%',?,'%');";
...
//        // kết nối DB
        Connection connection = BaseRepository.getConnectDB();
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(SEARCH_BY_NAME3);
